...
//@interface GastosTableViewController : UITableViewController <NSFetchedResultsControllerDelegate, CreaGastoDelegado, PickDates, UIPickerViewDelegate, UIPickerViewDataSource,UIActionSheetDelegate>

@interface GastosTableViewController : UIViewController <UITableViewDelegate, UITableViewDataSource, NSFetchedResultsControllerDelegate, CreaGastoDelegado, PickDates, UIPickerViewDelegate, UIPickerViewDataSource,UIActionSheetDelegate>
