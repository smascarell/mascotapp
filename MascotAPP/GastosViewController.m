...
//        NSData *pngData = [NSData dataWithContentsOfFile:g.perteceneMascota.img90];
//        UIImage *image90 = [UIImage imageWithData:pngData];
//        cell.imgMascota.image = [image90 thumbnailImage:60 transparentBorder:0 cornerRadius:5 interpolationQuality:kCGInterpolationDefault];
//        
//    } else {
...
- (IBAction)crearGastoBtn:(id)sender {
    [self performSegueWithIdentifier:@"CrearGasto" sender:self];
}
